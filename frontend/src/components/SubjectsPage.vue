  ...
  <div class="directory-page">
    ...
    <div class="majors-grid">
      <div
        ...
        :id="`major-${major.id}`"
        class="major-card"
        :class="{ 'active': selectedMajors.some(m => m.id === major.id) }"
      ...
      >
        ...
        <div v-if="selectedMajors.some(m => m.id === major.id)" class="courses-list">
          <div
            v-for="courseGroup in groupCoursesByBaseCode(major.courses)"
...
/* Similar to majors: Updated course css and activated if the isCourseActive function is true?  */
.active-course {
  border-left: 4px solid #4299e1;
}
.section-link {
